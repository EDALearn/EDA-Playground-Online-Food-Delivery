// formatter:off
package io.zenwave360.example.delivery;
...
@AnalyzeClasses(packages = "io.zenwave360.example.delivery", importOptions = DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule respectsLayersForHexagonalArchitecture = layeredArchitecture()
        .consideringOnlyDependenciesInAnyPackage("io.zenwave360.example.delivery..")
        .layer("Any").definedBy("..")
