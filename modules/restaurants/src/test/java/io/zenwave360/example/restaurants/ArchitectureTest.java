// formatter:off
package io.zenwave360.example.restaurants;
...
@AnalyzeClasses(packages = "io.zenwave360.example.restaurants", importOptions = DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule respectsLayersForHexagonalArchitecture = layeredArchitecture()
        .consideringOnlyDependenciesInAnyPackage("io.zenwave360.example.restaurants..")
        .layer("Any").definedBy("..")
