// formatter:off
package io.zenwave360.example.orders;
...
@AnalyzeClasses(packages = "io.zenwave360.example.orders", importOptions = DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule respectsLayersForHexagonalArchitecture = layeredArchitecture()
        .consideringOnlyDependenciesInAnyPackage("io.zenwave360.example.orders..")
        .layer("Any").definedBy("..")
